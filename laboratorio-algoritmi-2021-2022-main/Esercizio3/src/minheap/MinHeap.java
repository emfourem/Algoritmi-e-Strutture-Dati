...
public class MinHeap<T> {
  ...
  public MinHeap(Comparator<? super T> comparator) throws MinHeapException {
    ...
    //hashmap elemento come chiave ,indice dell'elemento nell'array
  ...
  private void buildMinHeap() throws MinHeapException {
    //all'heapsize assegno la size dello heap,heapsize è la lunghezza dello heap
  ...
  public void heapInsert(T elem) throws MinHeapException {
    ...
    //addElement alza heapsize perchè aggiunge in ultima posizione
